# Bubbles theme (Greyish Accents) for Windows 11 Taskbar Styler

This is a clone of the original Bubbles Theme, but with Greyish accents.
**Originally made by**: [m417z](https://github.com/m417z)
**Clone made by**: [Moh23John](https://github.com/Moh23John)

![Screenshot2](Screenshot.png)

## Installation

The theme can be installed manually following these steps:
